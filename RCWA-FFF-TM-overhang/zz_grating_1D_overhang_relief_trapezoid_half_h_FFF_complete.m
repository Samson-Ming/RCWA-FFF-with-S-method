...
N_l    =10;           % lower number of layers
N_u    = 50;           % upper number of layers
...
for nMax =  nMax_l:nMax_step:nMax_u
    ...
    t(1,k)=3/4*zV(k)+Lam/4;
    t(2,k)=1/4*zV(k)+3/4*Lam;
...
%filename = 'dielectric_overhang_relief_trapezoid_half_h_TM_1percent_N=46_L=40.mat';
save(filename)
%exit
