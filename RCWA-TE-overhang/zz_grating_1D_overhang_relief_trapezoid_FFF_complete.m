...
RS_ref=[0.0115267715928461	0.00398810783818142	0.00265004449545881];
TS_ref=[0.0991436832629474	0.477843267855321	0.0998967367239539	0.268201698135929	0.0381740779684356];
%}
...
nMax_l    =8;         % lowest number of modes
nMax_u    =8;         % highest number of modes
nMax_step = 1;          % length of the step - modes

N_l    = 12;           % lower number of layers
N_u    =12;           % upper number of layers
...
%% Save results to a file
       ...
       error_study=error(:,:,7);
%% Save results to a file
filename = 'dielectric_overhang_relief_trapezoid_TE_N=17_L=12.mat';
%filename = 'dielectric_overhang_relief_trapezoid_TE_2.mat';
save(filename)
%exit
